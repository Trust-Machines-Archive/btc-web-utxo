...
const fromAddr = (<HTMLInputElement>document.getElementById('from-address')).value.trim()
const utxoCount= (<HTMLInputElement>document.getElementById('utxo-count')).value.trim()
const toAddress = (<HTMLInputElement>document.getElementById('to-address')).value.trim()
